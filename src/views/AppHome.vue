<template>
  ...
  <p class="text-muted fst-italic">
    {{t('home.feedback')}}
    <a href="https://boardgamegeek.com/thread/3437074/brdgmme-millennia-solo-helper-web-application" target="_blank" rel="noopener">Board Game Geek Thread</a> |
    <a href="https://github.com/brdgm/millennia-solo-helper" target="_blank" rel="noopener">GitHub</a>
  </p>
  ...
  <p class="disclaimer">
    ...
    All art in this app is from <a href="https://karma-games.com/millennia/" target="_blank" rel="noopener">Millennia: Tracks of Time</a>.
